...
import mzml from "./asset/mzml.jpg"
import rahman from "./asset/rahman.jpg"
import saad from "./asset/saad.jpg"
import samid from "./asset/samid.jpg"
import world from "./asset/360_F_792667822_D29gxLC1b111YhyC03165xeT3TbzitQZ.jpg"
import logo from "./asset/download (6).jpg"
import workerman from "./asset/professional-img.png"
import worldmap from "./asset/db0cca63d74349164650cb5bb3001bf4.jpg"
        ...
        <div className="row">
          <div className="col-md-6 ">
            <div className="detail-box">
              ...
              <p>
                Ready to take the leap into your next adventure? Whether you’re dreaming of a tropical island escape or an off-the-beaten-path journey, Travel with Ismail is here to guide you. Let’s make your next trip the best one yet!              </p>
              <a href="">
                Contact Us
              </a>
            </div>
        ...
        <div className="col-sm-6 col-md-4 mx-auto">
          <div className="box ">
            ...
            <div className="detail-box">
              ...
              <p>
                Ismail’s deep knowledge of destinations worldwide ensures you have an authentic travel experience, every step of the way.
              </p>
            </div>
          </div>
        </div>
        <div className="col-sm-6 col-md-4 mx-auto">
          <div className="box ">
            ...
            <div className="detail-box">
              ...
              <p>
                Say goodbye to stress. From booking flights to accommodations and activities, we take care of all the details so you can focus on enjoying the journey.
              </p>
            </div>
          </div>
        </div>
        <div className="col-sm-6 col-md-4 mx-auto">
          <div className="box ">
            ...
            <div className="detail-box">
              ...
              <p>
                We prioritize your safety, ensuring that every trip is organized with top-rated travel partners and expert guides.
        ...
        <div className="owl-carousel">
          <div className="item">
            <div className="box">
              ...
              <div className="client_text">
                <p>
                  "Traveling with Ismail was an absolute game-changer! He took care of everything, and the personalized itinerary made all the difference. I discovered so much more than I ever expected."
                </p>
              </div>
            </div>
          </div>
          <div className="item">
            <div className="box">
              ...
              <div className="client_text">
                <p>
                  "Ismail’s guided tour through Kyoto was incredible. His deep knowledge of the culture and history made the experience unforgettable."
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="col-md-4">
                <a href="">
                  <div className="item ">
                    ...
                    <p>
                      Have a question or want to start planning your next trip? Reach out to us today, and let’s talk about your travel dreams!
  ...
  <footer className="footer_section">
    <div className="container">
      <p>
        ...
        <a href="https://html.design/">Travel with Ismail</a>
      </p>
    </div>
  </footer></>
  )
